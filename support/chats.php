...
<div class="name">Admin - Lewis Hamilton (Support)</div>
...
<form name="form" action = "chats.php" method="POST">
    ...
    <input type="hidden" id="name_input" name="name_input" value="'.$_POST['name_input'].'">
...
<form name="form" action = "chats.php" method="POST">
    ...
    <input type="hidden" id="name_input" name="name_input" value="'.$_SESSION['name_input'].'">
