...
<body style="background:linear-gradient(270deg, rgba(158, 0, 169, 0.78) 0%, rgba(176,176,176,1) 70%)">
...
<div align="center">
<p class = "dbInfo" style = "font-size: 50px;font-weight: 700;margin-top:0.3%;margin-bottom:0%">FORMULA 1 CAR EDIT</p>
<br>
<br>
<p class = "dbInfo" style = "font-size: 25px;font-weight: 400;margin-top:0.3%;margin-bottom:0%;margin-left: 1.5%">Here you can <b>insert</b> an instance by filling the boxes below or <b>delete</b> an instance by clicking DELETE from the Car table.</p>

<?php 
include "carTableDrawer.php";
?>

<form class="form-inline" action="carInsert.php" method="POST">
 
  <input type="number" id="carID" name="carID" min=0 placeholder="Car ID" required><br><br>
  <input type="text" id="carEngine" name="carEngine" placeholder="Car Engine" required ><br><br>
  <input type="number" id="carlength" name="carlength" min=3000 max=4000 placeholder="Chassis Length" required><br><br>
