...
if (!isset($_POST['attributes'])){
    ...
    header ("Location: teamSearchPage.php");
}
...
<div id="goback"> 
<svg onclick="window.location.href = 'teamSearchPage.php'" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="80%" x="0px" y="0px" viewBox="0 0 261.2 39.4" style="enable-background:new 0 0 221.2 39.4;" xml:space="preserve"> <style type="text/css"> .st0{fill:#FFFFFF;} .st1{font-family:'Formula1-Display-Bold';} .st2{font-size:29px;} .st3{font-size:37px;} #Layer_1{cursor: pointer;} </style> <text transform="matrix(1 0 0 1 19.0044 28.4741)" class="st0 st1 st2">SEARCH PAGE</text> <text transform="matrix(1 0 0 1 -2.098083e-04 32.3751)" class="st0 st1 st3">&lt;</text> </svg>
</div> 

<div align="center" class="table-container">

<p class = "dbInfo" style = "font-size: 50px;font-weight: 700;margin-top:2%;margin-bottom:0%">TEAM SEARCH RESULTS</p>
...
if($operationSelection == "smallerEqual"){
    ...
    $sql_statement = "SELECT * FROM Team WHERE $attributeSelection <= $valueSelection";
