...
<body style="background:linear-gradient(270deg, rgba(255, 169, 12, 0.79) 0%, rgba(176,176,176,1) 70%)">
...
<div align="center">
<p class = "dbInfo" style = "font-size: 50px;font-weight: 700;margin-top:0.3%;margin-bottom:0%">FORMULA 1 DRIVER EDIT</p>
<br>
<br>
<p class = "dbInfo" style = "font-size: 25px;font-weight: 400;margin-top:0.3%;margin-bottom:0%;margin-left: 1.5%">Here you can <b>insert</b> an instance by filling the boxes below or <b>delete</b> an instance by clicking DELETE from the Driver table.</p>

<?php 
include "driverTableDrawer.php";
?>

<form class="form-inline" action="driverInsert.php" method="POST">
 
  <input type="number" id="driverNumber" name="driverNumber" min=0 placeholder="Driver Number" required><br><br>
  <input type="text" id="driverName" name="driverName" placeholder="Driver Name" required ><br><br>
  <input type="text" id="teamName" name="teamName" placeholder="Team Name" required ><br><br>
  <input type="number" min=0 id="points" name="points" placeholder="Points" required><br><br>
  <input type="number" min=0 id="podiums" name="podiums" placeholder="Podiums" required><br><br>
  <input type="number" min=0 id="championships" name="championships" placeholder="Championships" required><br><br>
  <input type="number" min=0 id="seasons" name="seasons" placeholder="Seasons" required><br><br>
  <input type="number" min=0 id="carID" name="carID" placeholder="Car ID" required><br><br>
