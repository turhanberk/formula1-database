...
<body style="background:linear-gradient(270deg, rgba(38, 187, 13, 0.79) 0%, rgba(176,176,176,1) 70%)">
...
<div align="center">
<p class = "dbInfo" style = "font-size: 50px;font-weight: 700;margin-top:0.3%;margin-bottom:0%">FORMULA 1 GP EDIT</p>
<br>
<br>
<p class = "dbInfo" style = "font-size: 25px;font-weight: 400;margin-top:0.3%;margin-bottom:0%;margin-left: 1.5%">Here you can <b>insert</b> an instance by filling the boxes below or <b>delete</b> an instance by clicking DELETE from the GP table.</p>

<?php 
include "gpTableDrawer.php";
?>

<form class="form-inline" action="gpInsert.php" method="POST">
 
<input type="text" id="gpName" name="gpName" placeholder="GP Name" required ><br><br>
<input type="text" id="circuitName" name="circuitName" placeholder="Circuit Name" required ><br><br>
<input type="number" id="winner" name="winner" min = 0 placeholder="Winner" required ><br><br>
  ...
  <input id="fastestLap" type="time" name="fastestLap" step="1" required> <br><br>
