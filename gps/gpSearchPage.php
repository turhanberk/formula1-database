...
<p class = "dbInfo" style = "font-size: 50px;font-weight: 700;margin-top:0.3%;margin-bottom:0%">FORMULA 1 GP SEARCH</p>
<br>
<br>
<p class = "dbInfo" style = "font-size: 25px;font-weight: 400;margin-top:0.3%;margin-bottom:1%;margin-left: 1.5%">Here you can query a <b>search</b> by filling the boxes below to filter the GP table.</p>
...
<form class="form-inline" action="gpSearchResults.php" method="POST" >

&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;
<select name="attributes" required>
 <option value="" disabled selected>Select attribute</option>
  <option value="gpName">GP Name</option>
  <option value="circuitName">Circuit Name</option>
  ...
  <input id="value" name="value" placeholder="Enter value" required><br><br> 
