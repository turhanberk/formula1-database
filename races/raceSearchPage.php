...
<p class = "dbInfo" style = "font-size: 50px;font-weight: 700;margin-top:0.3%;margin-bottom:0%">FORMULA 1 RACE SEARCH</p>
<br>
<br>
<p class = "dbInfo" style = "font-size: 25px;font-weight: 400;margin-top:0.3%;margin-bottom:1%;margin-left: 1.5%">Here you can query a <b>search</b> by filling the boxes below to filter the Race table.</p>
...
<form class="form-inline" action="raceSearchResults.php" method="POST" >
