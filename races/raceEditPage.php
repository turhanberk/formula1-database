...
<body style="background:linear-gradient(270deg, rgba(18, 131, 255, 0.79) 0%, rgba(176,176,176,1) 70%)">
...
<div align="center">
<p class = "dbInfo" style = "font-size: 50px;font-weight: 700;margin-top:0.3%;margin-bottom:0%">FORMULA 1 RACE EDIT</p>
<br>
<br>
<p class = "dbInfo" style = "font-size: 25px;font-weight: 400;margin-top:0.3%;margin-bottom:0%;margin-left: 1.5%">Here you can <b>insert</b> an instance by filling the boxes below or <b>delete</b> an instance by clicking DELETE from the Race table.</p>

<?php 
include "raceTableDrawer.php";
?>

<form class="form-inline" action="raceInsert.php" method="POST">
 
  <input type="number" id="driverNumber" name="driverNumber" min=0 placeholder="Driver Number" required><br><br>
  <input type="text" id="gpName" name="gpName" placeholder="GP Name" required ><br><br>
  <input type="number" min=1 max=20 id="position" name="position" placeholder="Position"><br><br>
